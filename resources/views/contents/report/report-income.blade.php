            ...
            <table>
                ...
                <tbody>
                    @foreach ($incomes as $income)
                        <tr>
                            <td class="service">{{ $income->reservation_number }}</td>
                            <td class="desc">{{ $income->name }}</td>
                            <td class="service">{{ $income->phone_number }}</td>
                            <td class="service">{{ $income->duration }}</td>
                            <td class="desc">{{ $income->room_number }}</td>
                            <td class="desc">{{ \Carbon\Carbon::parse($income->checkin_date)->format("d-m-Y") }}</td>
                            <td class="desc">{{ \Carbon\Carbon::parse($income->checkout_date)->format("d-m-Y") }}</td>
                            <td class="desc">{{ $income->total_price }}</td>
                        </tr>
                    @endforeach
                    <tr>
